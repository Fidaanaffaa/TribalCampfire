...
public class BoardManager : MonoBehaviour
{
    ...
    // GameObject[] notesToPlay = new GameObject[] {Resources.Load("E") as GameObject, Resources.Load("B")}
    ...
    private float[] beats_list = new float[]{0.25f, 0.25f, 0.25f, 0.25f, 0.25f, 0.25f, 0.25f, 0.25f, 0.25f,
        0.5f, 0.25f, 0.25f, 0.25f, 0.5f, 0.25f, 0.25f, 0.25f, 0.5f, 0.1f, 0.1f, 0.1f, 0.1f,0.1f,0.1f,0.1f }; // Changes beat per player
    ...
    public void PlayerSuccess()
    {
        ...
        for(int i = 0; i < playerCoords.Count; i++)
        {
            players[i].setNote(notes[notes_index]);
        }
        if(notes_index < notes.Count - 1)
        {
                notes_index += 1;
        }
    }
    ...
    // }
     ...
     List<AudioSource> LoadSong()
    {
        List<AudioSource> notes = new List<AudioSource>();
        string[] tabs = new string[] {"E_note","D_s_note","E_note","D_s_note","E_note","B_note","D_note"
        ,"C_note","A_note","C1_note","E1_note","A_note","B_note","E1_note","A_note","B_note","C_note"};
        for(int i = 0; i < tabs.Length; i++)
        {
            Debug.Log(tabs[i]);
            GameObject item = Instantiate(Resources.Load(tabs[i])) as GameObject;
